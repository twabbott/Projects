    ...
    render() {
        return (
            <tr>
                ...
                <td>
                    <button type="button" className="btn btn-info btn-sm" disabled={this.props.loading}
                        onClick={this._onEditBtnClicked}>Edit</button>
                </td>
                <td>
                    <button type="button" className="btn btn-danger btn-sm" disabled={this.props.loading}
